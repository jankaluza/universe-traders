...
#
# Created: Tue Dec 16 19:42:14 2014
...
class Ui_dialogEditor(object):
    def setupUi(self, dialogEditor):
        ...
        self.gridLayout.addWidget(self.events, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.dialog, 0, 1, 8, 1)
        ...
        self.gridLayout.addWidget(self.avatar, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.once, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.object, 2, 0, 1, 1)
