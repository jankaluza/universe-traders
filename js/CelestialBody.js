function CelestialBody(objManager, name, type, texture, x, y, items, prices, a, b, speed) {
...
CelestialBody.constructor = CelestialBody;
CelestialBody.prototype = Object.create(PIXI.Sprite.prototype);

CelestialBody.prototype.recountPosition = function() {
...
CelestialBody.prototype.reset = function() {
    this.demand = {};
    this.staged = false;
...
CelestialBody.prototype.save = function() {
...
CelestialBody.prototype.load = function() {
...
CelestialBody.prototype.doOrbitalMovement = function(addMapX, addMapY, addX, addY) {
    if (this.speed !== 0 && this.parentObject) {
        ...
        if (this.staged || this.cycles > 10) {
            ...
            // If the ship is on this CelestialBody, move the ship with this object.
...
CelestialBody.prototype.collides = function(x, y) {
...
if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports) {
        exports = module.exports = CelestialBody;
    }
}
